...
Offer this once a build succeeds; it's usually what "I want a docs site" ultimately meant. Read `seemore/references/publishing.md` and **let the user pick the host**. GitHub Pages, Netlify, Cloudflare Pages and Surge are all covered there.
